...
This is vibe-coded in the sense that I created it with OpenAI Codex and tested it and use it myself, but I have not
inspected the code. So you can use it at your own risk.

Caution: The AI Add feature sends selected log lines to OpenAI's API to get regex suggestions.
